 ...
 insert into event_day (id, eventdate, title, event_id) values (2, '2020-03-06', 'Event1 DAY 2', 1);
 ...
 insert into seats_ticket (id, price, single_day, day_id, event_id, sector_id, column_num, row_num) values (111, 5000, 1, 2, 1, 102, 1, 1);
 insert into seats_ticket (id, price, single_day, day_id, event_id, sector_id, column_num, row_num) values (222, 5000, 1, 2, 1, 102, 1, 2);
 insert into stand_ticket (id, price, single_day, day_id, event_id, sector_id) values(444, 2000, 1, 2, 1, 102);
