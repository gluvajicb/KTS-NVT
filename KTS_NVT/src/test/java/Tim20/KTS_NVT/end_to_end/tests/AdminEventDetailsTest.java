...
public class AdminEventDetailsTest {
    ...
    @Test
    public void SeeDetailsForOneEvent() {
        ...
        adminEventPage.ensureDetailsButtonIsClickable();
        adminEventPage.getDetailsButton().click();

        expectedURL = "http://localhost:4200/events/details/105";
        assertEquals(expectedURL, browser.getCurrentUrl());

        // Ovde pise Location Details na frontu //
        WebElement detailsText = browser.findElement(By.xpath("/html/body/app-root/div/div[2]/div/div/app-event-details/div[1]/h3"));

        assertEquals("Event Details", detailsText.getText());
    }
}
