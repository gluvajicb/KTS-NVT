...
public class SeatsTicketDTO {
	...
	public SeatsTicketDTO(Long eventID, Long eventDayID, boolean isSingleDay, double price, int rowNumber, int columnNumber, Long sectorID, boolean paid, String date) {
