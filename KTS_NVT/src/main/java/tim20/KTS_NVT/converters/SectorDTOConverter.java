...
public class SectorDTOConverter {
	...
	public static SectorDTO standSectorToDto(StandSector ss) {
		...
		SectorDTO dto = new SectorDTO(ss.getId(), ss.getTitle(), "Stand", ss.getMaxGuests(), -1, -1);
	...
	public static SectorDTO seatsSectorToDto(SeatsSector ss) {
		...
		SectorDTO dto = new SectorDTO(ss.getId(), ss.getTitle(), "Seats", -1, ss.getRowNum(), ss.getColumnNum());
